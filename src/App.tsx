            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 transition-all duration-300">
              ...
              <footer className="bg-slate-900 text-blue-200 py-8 transition-all duration-300">
                <div className="container mx-auto px-6">
                  <p className="text-lg md:text-xl font-sans font-bold mb-6 text-center">
                   EVENT COORDINATORS
                  </p>
                  <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-8 lg:space-x-32">
